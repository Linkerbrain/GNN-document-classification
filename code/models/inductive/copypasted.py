...
# https://github.com/cszhangzhen/HGP-SL/blob/master/main.py
class ModelProteinBest(torch.nn.Module):
    def __init__(self, vocab_size, feature_size, num_classes):
        super(ModelProteinBest, self).__init__()
